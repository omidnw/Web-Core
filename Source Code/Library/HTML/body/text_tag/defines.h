...
// a tag!
void atags(char* FilEName_Type, char value[1000], char href[255], char target[255], char style[255], char download[255], char hreflang[255], char media[255], char ping[255], char referrerpolicy[255], char rel[255], char type[255], char endcondition[3], char brtag[3])
{
    htmlatagstart(FilEName_Type, value, href, target, style,
                  download, hreflang, media, ping, referrerpolicy, rel, type, endcondition, brtag);
}
